    ...
    <div class="container  ">
        ...
        <div class="py-2 d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center ">
                按照
                <form>
                    <select class="form-control  mx-2" aria-label="Default select example" style="width: 200px;" name="sort" onchange="this.form.submit()">
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                    <?php for ($i = 1; $i <= $totalPage; $i++) : ?>
                        <li class="page-item <?php if ($i == $page) echo "active"; ?>"><a class="page-link " href="order-list.php?page=<?= $i ?>&sort=<?= $sort ?>&type=<?= $type ?>"><?= $i ?></a></li>
                    <?php endfor; ?>
                </ul>
            </nav>
        <?php endif; ?>
