...
// $sqlTotal = "SELECT COUNT(*) AS totalOrder FROM orders ";
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="order-update.php?order_id=<?= $row["order_id"] ?> " class="btn btn-light shadow  bg-body-tertiary rounded">編輯</a></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
